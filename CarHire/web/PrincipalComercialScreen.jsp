<%-- 
    Document   : PrincipalComercialScreen
    Created on : 30-mar-2018, 12:25:52
    Author     : alejandrohd
--%>
...
<html>
    ...
    <body>
        <%            StatisticsApp estadisticas = (StatisticsApp) InitialContext.doLookup("java:global/CarHireEE/CarHireEE-ejb/StatisticsApp!singletonBeans.StatisticsApp");
            ...
            estadisticas.addAccess("PrincipalComercialScreen.jsp");
            ...
            logContent.logGenerator("PrincipalComercialScreen::" + (String) session.getAttribute("usuario"));
        %>
