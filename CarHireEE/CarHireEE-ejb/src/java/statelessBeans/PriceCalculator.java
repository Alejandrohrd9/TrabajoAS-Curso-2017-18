...
public class PriceCalculator {
    ...
    @PostConstruct
    public void create() {
        String trace = "PriceCalculator::create::@PostConstruct";
        try {
    ...
    public int calculatePriceDays(String price, String days,String userName) {
        String trace = "PriceCalculator::calculatePriceDays::"+userName;
        ...
        return priceValue * daysValue;

    }

    @PreDestroy
    public void preDestroy() {
        String trace = "PriceCalculator::preDestroy::@PreDestroy";
        try {
            logApp = (LogApp) InitialContext.doLookup("java:global/CarHireEE/CarHireEE-ejb/LogApp!singletonBeans.LogApp");
            traceG.traceDoc(trace);
            logApp.logGenerator(trace);
