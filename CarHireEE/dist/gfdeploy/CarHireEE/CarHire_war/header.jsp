<%-- 
    Document   : header
    Created on : 21-feb-2018, 16:56:03
    Author     : alejandrohd
--%>
        ...
        <div class="navbar navbar-expand-lg navbar-dark bg-dark">
            <nav class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbar2">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="btn btn-dark" class="nav-link" href="PrincipalManagerScreen.jsp">Inicio</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="btn btn-dark" class="nav-link dropdown-toggle"  data-toggle="dropdown" id="Preview" href="#" role="button" aria-haspopup="true" aria-expanded="false">Flota</a>
                            <div class="dropdown-menu" aria-labelledby="Preview">
                                <a class="dropdown-item" href="ViewCar.jsp">Ver flota</a>
                                <a class="dropdown-item" href="NewCar.jsp">Añadir coche</a>
                                <a class="dropdown-item" href="ViewDistributor.jsp">Distribuidor</a>
                            </div>
                        </li>

                        <li class="nav-item dropdown">
                            <a class="btn btn-dark" class="nav-link dropdown-toggle"  data-toggle="dropdown" id="Preview" href="#" role="button" aria-haspopup="true" aria-expanded="false">Personal</a>
                            <div class="dropdown-menu" aria-labelledby="Preview">
                                <form action="FrontServlet">
                                    <input type="hidden" name="command" value="ViewEmployeeCommand">
                                    <input type="submit" class="dropdown-item" class="nav-link" value="Ver personal">
                                </form>
                                <a class="dropdown-item" href="NewEmployee.jsp">Añadir empleado</a>
                            </div>
                        </li>
